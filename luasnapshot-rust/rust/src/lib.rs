...
pub extern "C" fn lua_gc_node_new(
    ...
    unsafe {
        let ptr = Box::new(LuaGcNode::new(
            LuaGcNodeType::from(node_type),
...
#[no_mangle]
pub extern "C" fn lua_gc_node_free(node: *mut LuaGcNode) {
    if node as u8 != 0 {
        unsafe {
...
#[no_mangle]
pub extern "C" fn lua_gc_node_count(node: *mut LuaGcNode) -> u32 {
    if node as u8 != 0 {
        unsafe {
            let n = &mut *node;
            return n.count();
...
#[no_mangle]
pub extern "C" fn lua_gc_node_set_desc(node: *mut LuaGcNode, desc: *const c_char) -> c_int {
    if node as u8 != 0 {
        unsafe {
            let n = &mut *node;
...
#[no_mangle]
pub extern "C" fn lua_gc_node_set_link(node: *mut LuaGcNode, link: *const c_char) -> c_int {
    if node as u8 != 0 {
        unsafe {
            let n = &mut *node;
...
#[no_mangle]
pub extern "C" fn lua_gc_node_copy(node: *mut LuaGcNode) -> *mut LuaGcNode {
    if node as u8 != 0 {
        unsafe {
            let n = &mut *node;
        ...
        return 0 as *mut LuaGcNode;
    }
}

#[no_mangle]
pub extern "C" fn lua_gc_node_copyall(node: *mut LuaGcNode) -> *mut LuaGcNode {
    if node as u8 != 0 {
        unsafe {
            let n = &mut *node;
...
#[no_mangle]
pub extern "C" fn lua_gc_node_print(node: *mut LuaGcNode) {
    if node as u8 != 0 {
        unsafe {
            let n = &mut *node;
            println!("{}", n.to_str());
...
#[no_mangle]
pub extern "C" fn lua_gc_node_add_child(father: *mut LuaGcNode, son: *mut LuaGcNode) {
...
#[no_mangle]
pub extern "C" fn lua_gc_node_to_str(node: *mut LuaGcNode) -> *const c_char {
    if node as u8 != 0 {
        unsafe {
            let n = &mut *node;
            let string = n.to_str();
...
pub extern "C" fn lua_gc_node_diff(
    node1: *mut LuaGcNode,
    node2: *mut LuaGcNode,
    incr: *mut *const LuaGcNode,
    decr: *mut *const LuaGcNode,
) {
...
#[no_mangle]
pub extern "C" fn lua_gc_node_get_refs(node: *mut LuaGcNode) -> u32 {
    if node as u8 == 0 {
        return 0;
    } else {
        unsafe {
...
#[no_mangle]
pub extern "C" fn lua_gc_node_set_refs(node: *mut LuaGcNode, refs: u32) {
    if node as u8 == 0 {
        return;
    } else {
        unsafe {
...
#[no_mangle]
pub extern "C" fn lua_gc_node_detach_first_child(node: *mut LuaGcNode) -> *mut LuaGcNode {
    if node as u8 == 0 {
        return 0 as *mut LuaGcNode;
    } else {
        unsafe {
